...
const MERCHANTS = [
  ...
  },
  {
    ...
    verifiedMerchant: true,
    acceptsCredentialFlow: true,
    refundPolicy: "Same-day replacement on damaged items",
    shipsTo: ["NZ"],
  },
  {
    id: "newworld",
    ...
    verifiedMerchant: true,
    acceptsCredentialFlow: true,
    refundPolicy: "Quality guarantee",
    shipsTo: ["NZ"],
  },
];
...
const OFFERS = [
  ...
  {
    productId: "keyboard-001",
    merchantId: "cryptoemporium",
    productUrl: "https://www.cryptoemporium.eu/",
    priceUsd: 259,
    shippingUsd: 6,
  ...
  },
  {
    ...
    merchantId: "countdown",
    productUrl: "https://www.countdown.co.nz/",
    priceUsd: 4.99,
    shippingUsd: 3.5,
    acceptedTokens: ["USDC"],
  ...
  },
  {
    ...
    merchantId: "newworld",
    productUrl: "https://www.newworld.co.nz/",
    priceUsd: 8.49,
    shippingUsd: 3.5,
    acceptedTokens: ["USDC"],
    supportedChains: ["avalanche"],

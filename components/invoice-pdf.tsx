...
export function InvoicePDF({ data }: { data: InvoiceData }) {
  ...
  return (
    <Document
      title={`Quarter ${data.invoiceNumber}`}
      author="Quarter AI Agent"
    >
      <Page size="A4" style={S.page}>
        ...
        <View style={S.headerRow}>
          <View>
            ...
            <Text style={S.generatedBy}>Generated by Quarter AI Agent</Text>
            <View style={S.badgeRow}>
              <View style={S.badgeDark}>
                <Text style={S.badgeDarkText}>{data.agentName}</Text>
              </View>
        ...
        <View style={S.billingRow}>
          <View style={S.billingCol}>
            ...
            <Text style={S.billingText}>{data.agentName}</Text>
            <Text style={S.billingMono}>{truncateAddress(data.agentWallet)}</Text>
          </View>
          <View style={S.billingCol}>
        ...
        <View style={S.footer}>
          <View>
            <Text style={S.footerBrand}>Quarter</Text>
            <Text style={S.footerSub}>AI-Powered Autonomous Shopping</Text>
            <Text style={S.footerENS}>{data.agentName}</Text>
          </View>
